...
public class DictionaryMinPrerequisite extends SingularMinPrerequisite
{
	@Element(name="categoryName")
	protected String m_keyToCheck;

	public DictionaryMinPrerequisite(
	...
	{
		this(null, stateValueName, minValue, keyToCheck);
	}
	...
	public DictionaryMinPrerequisite(
			...
			@Element(name="categoryName") String keyToCheck)
	{
		super(id, stateValueName, minValue);
	...
	public boolean passesPrerequisite(StoryNode node, StoryState storyState)
	{
		...
		if (found != null)
		{
			...
			ret = stateValue.getValue(m_keyToCheck) >= m_minValue;
		}
